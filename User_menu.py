...
account_num = savingsAccount.account_num




# Providing the option menu
...
with a1:
    option = option_menu("User Menu", ["View Balance","Statement(Analysis)","Funds Transfer","Pay bills","Deposit",'Logout'], 
    icons=['house','cloud-arrow-up-fill','repeat'], menu_icon="menu-up", default_index=0,orientation ="vertical",key='op2')

# Transactions                                      
with a2:
        
        if option == "Funds Transfer":
                try:                         
        ...
        # Allows user deposit(only for demo purpose)                                                                                                                                                                                      
