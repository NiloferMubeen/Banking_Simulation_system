...
class SavingsAccount(Account):
    ...
    def authenticate(self, name,pwd, accountNumber):
        print()
        if accountNumber in self.savingsAccounts.keys():
            if self.savingsAccounts[accountNumber][0] == name and self.savingsAccounts[accountNumber][1] == pwd:
...
while True:
    ...
    if userChoice == 1:
        ...
        deposit = int(input())
        savingsAccount.createAccount(name,pwd, deposit)
        print()
    elif userChoice == 2:
        print()
        print("Enter your name: ")
        ...
        authenticationStatus = savingsAccount.authenticate(name,pwd, accountNumber)
        print()
